      ...
      <header>
        ...
        <nav className="p-4" aria-label="Weekly assignments">
          <ul className="flex flex-col gap-1">
            ...
            <li  className={weeklyAssignmentLinkStyle}>
              <Link className={weeklyAssignmentLinkTextStyle} href="/week-5">
                Week 5 Assignment
              </Link>
            </li>
            <li  className={weeklyAssignmentLinkStyle}>
              <Link className={weeklyAssignmentLinkTextStyle} href="/week-6">
                Week 6 Assignment
              </Link>
            </li>
            <li  className={weeklyAssignmentLinkStyle}>
            ...
            <li  className={weeklyAssignmentLinkStyle}>
              <Link className={weeklyAssignmentLinkTextStyle} href="/week-8">
                Week 8 Assignment
              </Link>
            </li>
          </ul>
